...
simu_balboa.m and simu_balboa.py: Both documents compile the same algorithm, one in matlab, the other in python. The python code compiles much faster and is more optimised.
